              ...
              <div class='px-6 py-3 m-2 border-8 border-gray-300' x-data="{
                ...
                <div class="grid bg-white turngrid">
                  ...
                  <div class="flex justify-between my-4 mr-4 text-2xl text-indigo-400 w-fullp-2 flex-between">
                    ...
                    <input
                        type="hidden"
                        name='<?php echo e($player_primary); ?>'
                        :value="primaryTotal()">
                  </div>
                <div>
                    <div class="w-full max-w-lg pb-4">
                      <div
                        ...
                        <input
                            type="hidden"
                            name="<?php echo e($player_secondary); ?>"
                            :value="getsecondaryTotal()">
                      </div>
                        <?php echo $__env->make("_category_select", ['categories'=>$categories, 'selection_id'=>'selection_1', 'count_id'=>"count"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make("_category_select", ['categories'=>$categories, 'selection_id'=>'selection_2', 'count_id'=>"counta"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make("_category_select", ['categories'=>$categories, 'selection_id'=>'selection_3', 'count_id'=>"countb"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/vagrant/scoretracker/resources/views/_player_layout.blade.php ENDPATH**/ ?>