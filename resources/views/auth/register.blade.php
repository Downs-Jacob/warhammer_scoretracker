                    ...
                    <div class="mb-2 text-lg font-bold">{{ __('Register') }}</div>
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class='mb-2'>
                                ...
                                <input class="w-full p-2 border border-gray-400" type="text" name="username" id="username" value="{{ old('username') }}" required>
                            ...
                            <div class='mb-2'>
                                ...
                                <input class="w-full p-2 border border-gray-400" type="text" name="name" id="name" value="{{ old('name') }}" required>
                            ...
                            <div class='mb-2'>
                                ...
                                <input class="w-full p-2 border border-gray-400" type="text" name="email" id="email" value="{{ old('email') }}"
