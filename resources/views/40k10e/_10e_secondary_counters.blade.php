<div class="text-base">
    <div class="flex justify-between w-full">
        <div class="flex items-center">
            <label class="block md:pt-3 lg:pt-3 xl:pt-3 mb-2 text-small font-bold tracking-wide text-indigo-400 uppercase" for="grid-grandstrat">
        ...
        <div class="flex items-center">
            ...
            <div x-text="{{$count_id}}" class="text-base text-slate-500 w-8 pr-4 font-bold text-right" id="{{$count_id}}"></div>
        </div>
    </div>
</div>
