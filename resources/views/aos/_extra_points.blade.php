    ...
    <div class="flex justify-between w-full py-2 pb-4 border-b border-blue-800">
        ...
        <div class="flex items-center m-2">
            <div class="ml-2 lg:px-4">
                <button class="px-4 py-3 mr-2 lg:mr-6 font-bold text-white bg-red-500 border border-blue-700 rounded hover:bg-red-600"
                    @click.prevent="if({{$count_id}}>0) {{$count_id}}-=1">
                </button>
                <button class="px-4 py-3 mr-2 lg:mr-6 font-bold text-white bg-green-500 border border-blue-700 rounded hover:bg-green-600"
