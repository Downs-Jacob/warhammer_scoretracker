...
<body class="font-sans leading-normal tracking-normal">
    <div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
		<div class="flex flex-col w-full lg:w-1/2 items-start pb-80 px-6">
		...
		<!--Right Col-->
		<div class="w-full lg:w-1/2 lg:py-6 pb-80 text-center">
			<!--Add your product image here-->
            <img class="pb-80 fill-current mx-auto column-tout__image" src="https://www.games-workshop.com/resources/touts/2019-01-05/Home/Register_190105_All.png" viewBox="0 0 20 20" alt="" data-gtm-ea="/image/featuredMedia">
