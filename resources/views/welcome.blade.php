...
<body class="font-sans leading-normal tracking-normal">
    <div class="container flex flex-col md:flex-row items-center my-10 md:my-24">
		<div class="flex flex-col w-full lg:w-1/2 items-start pb-48 px-6 lg:pl-20">
		...
		@if (auth()->check())
			...
			<a href="/create" 
				class="flex-1 px-4 py-2 font-bold text-white bg-blue-500 rounded-full mr-l hover:bg-blue-700">
				Start New Game
			</a>
		@else
			<p class="leading-normal mb-4">
