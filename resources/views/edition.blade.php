...
@section('content')
<head>
    <title>Edition Selection</title>
</head>
<body>
    <div class="flex flex-col items-center h-screen">
        <div class="bg-gray-200 w-full px-4 py-8 mb-8">
            <p class="text-center text-xl sm:text-3xl font-extrabold">Please choose the edition you want to track</p>
        </div>
        <div class="flex flex-col sm:flex-row items-center py-16">
            <a href="{{ route('scorecard10th') }}">
